...
export default function Home() {
    ...
    return (
        <div className={`p-5 md:p-10 w-[100vw] h-[100vh] flex flex-col ${theme === 'light' ? 'bg-[#F7F7F8]' : 'bg-[#292B32]'}`}>
          <button onClick={HandleThemeChange} className={`absolute top-10 right-10 w-8 h-8 md:w-10 md:h-10`}>
            ...
            <div className={`flex flex-col`}>
                ...
                <button className={`mt-7 self-center bg-[#2C9CF0] text-white w-[125px] h-[46px] font-[600] text-[16px] leading-[26px]`}>See More</button>
            </div>

            <div className={`mt-[50px] flex flex-col items-center p-10 ${theme === 'light' ? 'text-black' : 'text-[#ffffff]'}`}>
