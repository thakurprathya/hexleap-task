...
export default function Home() {
    ...
    return (
        <>
            <button onClick={HandleThemeChange} className={`fixed top-10 right-10 w-8 h-8 md:w-10 md:h-10`}>
            ...
            <div className={`p-5 md:py-10 md:px-20 w-full h-full flex flex-col items-center ${theme === 'light' ? 'bg-[#F7F7F8]' : 'bg-[#292B32]'}`}>
                <div className={`flex flex-col`}>
                    ...
                    <div className={`mt-[20px] flex gap-4 flex-wrap`}>
                        {/* cards */}
                    ...
                    <button className={`mt-12 self-center bg-[#2C9CF0] text-white w-[125px] h-[46px] font-[600] text-[16px] leading-[26px]`}>See More</button>
                </div>
